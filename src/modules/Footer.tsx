...
export default function Footer() {
  return (
    <footer className="max-w-screen-2xl mx-auto px-4 md:px-8 lg:px-16 <sm:pt-4 sm:pt-10 lg:pt-12">
      {/* <div className="flex flex-col md:flex-row justify-between items-center border-t border-b gap-4 py-6"> */}
        ...
        {/* <nav className="flex flex-wrap justify-center md:justify-start gap-x-4 gap-y-2 md:gap-6">
          <a href="#" className="text-gray-400 hover:text-indigo-500 active:text-indigo-600 transition duration-100">
            About
          </a> */}
          {/* <a
            href="#"
        ...
        {/* <div className="flex gap-4"> */}
          ...
          {/* <a
            href="https://github.com/perishllc/"
            target="_blank"
            className="text-gray-400 hover:text-gray-500 active:text-gray-600 transition duration-100"
          >
            <svg
        ...
        {/* social - end */}
      {/* </div> */}
      <div className="text-gray-400 text-sm text-center py-8">© 2022 - Perish LLC. All rights reserved.</div>
    </footer>
  );
}
