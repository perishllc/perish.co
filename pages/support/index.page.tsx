          ...
          <div className="bg-gray-50 py-16 px-6 lg:col-span-2 lg:px-8 lg:py-24 xl:pr-12">
            <div className="mx-auto max-w-lg">
              ...
              <p className="mt-3 text-lg leading-6 text-gray-500">
                Have a question? Need help? Contact us and we'll be happy to assist you.
              </p>
              <dl className="mt-8 text-base text-gray-500">
                <div>
                  <dt className="sr-only">Postal address</dt>
                  <dd>
                    <p>2774 East Colonial Drive Suite C #1187</p>
                ...
                <div className="mt-3">
                  ...
                  <dd className="flex">
                    ...
                    <span className="ml-3">support@perish.co</span>
                  </dd>
                </div>
              </dl>
            </div>
